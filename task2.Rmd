...
## Consumption foreacsting with average forecast and optimal weights

```{r Dynamic and ARIMA combination, echo=FALSE, message=FALSE, warning=FALSE}
# Dynamic and ARIMA ----
...
```{r Dynamic and autoARIMA, echo=FALSE, message=FALSE, warning=FALSE}
# ARIMA and autoARIMA comparison ----
# Averaging: Auto and Manual
comb_am <- (fcs.adv[["mean"]]+fcs.adv.3[["mean"]])/2
...
```{r DR, ETS and TBATS, echo=FALSE, message=FALSE, warning=FALSE}
# With ETS and TBATS ----
# Averaging: ETS, TBATS
...
## Plotting of data and combined forecast
...
## Forecasts measurements and comparison

```{r Measurements comparison, echo=FALSE, message=FALSE, warning=FALSE}
