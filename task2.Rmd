...
zoom.plot <- autoplot(tse[,1], color = "black", series = "Income") +
  ...
  scale_y_continuous(name = "Consumption AUD mn.",
                     breaks = seq(0, 500000, by = 125000))
...
knitr::kable(arima.comp.1,
             booktabs = T,
             caption = "Evaluation of ARIMA models")
```
...
f10 <- autoplot(forecast(fit.5, h =39), series = "Forecast") +
  ...
  scale_x_continuous(limits = c(1990,2020)) # Fig. 10 #no cap
...
```{r Figure 15 errors comparison, echo=FALSE, fig.cap="Residual Analysis fpr Automated Selected ARIMA model", fig.height=3, fig.width=8, message=FALSE, warning=FALSE}
...
ggarrange(fcs.adv.3.plot, fcs.adv.plot, nrow = 2, common.legend = T) # fig 17
```
...
```{r Appendix 4 log residual analysis, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.width=8, fig.cap="Residual Analysis for First Differencing"}
checkresiduals(log(tse[,1])) # Appendix 2
```

```{r Appendix 5 second order diff-log analysis, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.width=8, fig.cap = "Residual Analysis for First-Order Seasonal Differencing"}
checkresiduals(diff(diff(log(tse[,1]),4),1)) # Appendix 3
```

```{r Appendix 6 second order diff-log CE, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.width=8, fig.cap = "Residual Analysis for First-Order Seasonal Differencing for Consumption"}
checkresiduals(diff(diff(log(tse[,2]),4),1)) # Appendix 5
```

```{r Appendix 7 first ARIMA model, fig.height=2, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
(fit.1 <- Arima(ts.train[,2], order = c(0,1,3), seasonal = c(0,1,2), lambda = BoxCox.lambda(ts.train[,2])))
...
```{r Appendix 8 second ARIMA model, fig.height=2, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
(fit.2 <- Arima(ts.train[,2], order = c(1,1,3), seasonal = c(0,1,2), lambda = BoxCox.lambda(ts.train[,2])))
...
```{r Appendix 9 residual analysis, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(fit.1)$p.value # Appendix 7
```

```{r Appendix 10 residual analysis, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(fit.2) # Appendix 8
```

```{r Appendix 11 ACF and PACF, fig.height=2, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Appendix 13 DR residual analysis, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(fit.arima.adv.1) 
```

```{r Appendix 14a residua analysis for comparison, fig.height=2, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(ce.acf.adv.2,ce.pacf.adv.2, ncol = 2) # Appendix XYZ 
```

```{r Appendix 14b, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(fit.arima.adv.2) # Appendix XYZ
```

```{r Appendix 15 residual analysis, fig.height=3, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
