...
```{r Figure 4 ARIMA (2,1,3)(0,1,2)[4], echo=FALSE, message=FALSE, warning=FALSE, results = FALSE, fig.cap = "ACF and PACF Analysis for ARIMA (2,1,3)(0,1,2)[4] model"}
...
```{r ARIMA and DR plot, echo=FALSE, message=FALSE, warning=FALSE}
# ARIMA + Dynamic ARIMA ----
c_1 <- autoplot(tse[,2]) +
...
```{r Manual and autoARIMA plot, echo=FALSE, message=FALSE, warning=FALSE}
...
c_4 <- autoplot(tse[,2]) +
  ...
  ggtitle("Forecasts combination: TBATS and ETS", 
